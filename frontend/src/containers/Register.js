        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={(event) => this.handleSubmit(event)}>
                    ...
                    {/* Phone field would be active in a non trial version of Twilio */}
                    {/* Currently Twilio only offers one trial number and a single verified number in the unpaid version */}
                    {/* <div className={'form-group' + (submitted && !user.phone ? ' has-error' : '')}>
                        <TextField htmlFor="phone" label="Phone" type="text" className="form-control" name="phone" value={user.phone} onChange={(event) => this.handleChange(event)} />
